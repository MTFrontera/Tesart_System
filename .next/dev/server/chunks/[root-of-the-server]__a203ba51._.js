...
async function GET() {
    try {
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute(`SELECT o.OrderID, o.OrderDate, o.OrderStatus, o.DeliveryMethod, o.TotalAmount,
...
async function POST(request) {
    try {
        ...
        const [result] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute('INSERT INTO `order` (CustomerID, EmployeeID, OrderDate, OrderStatus, DeliveryMethod, TotalAmount) VALUES (?, ?, ?, ?, ?, ?)', [
            CustomerID,
            EmployeeID,
            OrderDate,
            OrderStatus,
...
async function PUT(request) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute('UPDATE `order` SET CustomerID = ?, EmployeeID = ?, OrderDate = ?, OrderStatus = ?, DeliveryMethod = ?, TotalAmount = ? WHERE OrderID = ?', [
            CustomerID,
            EmployeeID,
            OrderDate,
            OrderStatus,
...
async function DELETE(request) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute('DELETE FROM `order` WHERE OrderID = ?', [
            OrderID
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a203ba51._.js.map